...
const Login: React.FC = () => {
  ...
  // ✅ ฟังก์ชันจำลองการกดปุ่ม Google OAuth
  const handleGoogleMockup = () => {
    alert("🚀 Google OAuth Triggered!\n\n(Mockup: ระบบจะส่งข้อมูลไปให้แอดมินหลักอนุมัติ และสถานะบัญชีของคุณจะอยู่ในโหมด 'Pending')");
  };
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl shadow-gray-200/50 sm:rounded-3xl sm:px-10 border border-gray-100">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Error Message */}
            {error && (
              <div className="bg-red-50 border border-red-100 text-red-600 text-sm font-bold text-center py-3 rounded-xl animate-pulse">
                {error}
              </div>
            )}
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              ...
              >
                {/* SVG Google Logo เพื่อความสมจริง */}
